...
/**
 * @todo: Quản lý content của header bên trái
 ...
 * @since: 16-05-2020
*/
class HeaderLeft extends Widget {

    /**
     * @var string
     */
    protected $view = 'layout::widgets.header.header-left';

    /**
     * HeaderLeft constructor.
     * @param Closure|MenuItem|Renderable|Buildable|Htmlable|View|string nội dung trong header bên trái
     */
     ...
     * - hỗ trợ render dữ liệu ra view của trait Viewable
     * @author: Croco
     * @since: 16-05-2020
     * @return array
     */
